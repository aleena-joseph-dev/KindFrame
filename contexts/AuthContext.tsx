  ...
  useEffect(() => {
    ...
    const getInitialSession = async () => {
      try {
        ...
        if (error) {
          console.log('⚠️ AUTH CONTEXT: No session found, continuing without authentication');
          setSession(null);
          setUser(null);
        } else {
        ...
        console.log('⚠️ AUTH CONTEXT: Error getting session, continuing without authentication:', error);
        setSession(null);
        setUser(null);
      } finally {
        setLoading(false);
